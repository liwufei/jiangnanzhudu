...
return array(
   ...
   'autoreg' 		=> '关注自动注册',
   'autoreg_desc' 	=> '关注公众号后自动注册为会员',
   'gatewayUrl' 		=> 'URL(服务器地址)',
   
   'weixin_menu'		=> '自定义菜单',
   'weixin_addmenu'  => '添加自定义菜单',
   'weixin_editmenu'  => '编辑自定义菜单',
   'menus_list' 		=> '列表',
   'menu_name'			=> '菜单名称',
   'parent' 			=> '上级菜单',
   'menu_type'			=> '菜单类型',
   ...
   'no_such_reply'		=> '没有该回复',
   'subscribe_reply' 			=> '关注自动回复',
   'text_reply'			=> '消息自动回复',
   'keyword_reply'			=> '关键词自动回复',
   'msg_type'			=> '消息类型',
   'subscribe_add_already'	=> '关注自动回复已经添加，不可以重复添加，请返回编辑',
   'text_add_already'	=> '消息自动回复已经添加，不可以重复添加，请返回编辑',
