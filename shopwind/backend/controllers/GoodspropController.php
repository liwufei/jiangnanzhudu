...
class GoodspropController extends \common\base\BaseAdminController
{
	public function actionIndex()
	{
		...
		$this->params['_foot_tags'] = Resource::import(['script' => 'javascript/treetable/ptree.js,javascript/inline_edit.js']);
