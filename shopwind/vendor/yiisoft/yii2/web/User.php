...
class User extends Component
{
    ...
    public function loginRequired($checkAjax = true, $checkAcceptHeader = true)
    {
        ...
        // @author shopwind Access to the authorized page not to redirect, response json instead.
		if($request->getIsAjax()) {
			Yii::$app->getResponse()->format = Response::FORMAT_JSON;
			Yii::$app->getResponse()->data = ['done' => false, 'icon' => 'warning', 'msg' => Yii::t('yii', 'Login Required'), 'loginUrl' => \yii\helpers\Url::toRoute($this->loginUrl, true), 'returnUrl' => $request->getAbsoluteUrl()];
			return false;
		}
