...
class SDK
{
	...
	public function create(array $params)
	{
		...
		if($this->ext_js) {
			$include_js = Resource::import('javascript/webuploader/webuploader.js,javascript/webuploader/js/handlers.js');
		}
		if($this->ext_css) {
			$include_css = Resource::import('javascript/webuploader/webuploader.css', 'style');
		}
		if(!$this->swf) {
			$this->swf = Resource::getResourceUrl(['file' => 'javascript/webuploader/Uploader.swf']);
		}
