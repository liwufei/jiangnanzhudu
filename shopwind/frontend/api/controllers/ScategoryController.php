...
class ScategoryController extends \common\base\BaseApiController
{
	/**
 	 * @获取店铺分类列表
    ...
    public function actionList()
    {
		...
		$model = new \frontend\api\models\ScategoryForm();
    ...
    public function actionUpdate()
    {
		...
		$model = new \frontend\api\models\ScategoryForm(['cate_id' => $post->cate_id]);
