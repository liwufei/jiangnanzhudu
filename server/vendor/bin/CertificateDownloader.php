 ...
 *
 * This file includes the referenced bin path (../wechatpay/wechatpay/bin/CertificateDownloader.php) using ob_start to remove the shebang if present
...
$binPath = __DIR__ . "/" . '../wechatpay/wechatpay/bin/CertificateDownloader.php';
