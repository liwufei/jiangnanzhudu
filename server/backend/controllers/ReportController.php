...
class ReportController extends \common\base\BaseAdminController
{
	...
	public function actionVerify()
	{
		...
		ReportModel::updateAll(['status' => 1, 'examine' => $this->params['visitor']['username'], 'verify' =>  $post->verify], ['in', 'id', array_keys($list)]);
