...
class GcategoryController extends \common\base\BaseAdminController
{
	public function actionIndex()
	{
		...
		$this->params['_foot_tags'] = Resource::import(['script' => 'javascript/treetable/gtree.js,javascript/inline_edit.js']);
