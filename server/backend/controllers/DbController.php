...
class DbController extends \common\base\BaseAdminController
{
	/**
	 * 从数据库列表
	 */
	...
	{
		$config = include(Yii::getAlias('@public').'/data/config.php');
		...
		$this->params['_foot_tags'] = Resource::import([
			'script' => 'javascript/jquery.ui/jquery.ui.js,javascript/jquery.ui/i18n/' . Yii::$app->language . '.js,javascript/dialog/dialog.js',
            'style' =>  'javascript/jquery.ui/themes/smoothness/jquery.ui.css,javascript/dialog/dialog.css'
		]);
	...
	public function actionSlave()
	{
		...
		$file = Yii::getAlias('@public').'/data/config.php';
		$config = include($file);
