...
class DefaultController extends \common\base\BaseAdminController
{
	/**
	...
	public function actionIndex()
	{
		...
		$this->params['_foot_tags'] = Resource::import('javascript/echarts/echarts.min.js,javascript/echarts/macarons.js');
