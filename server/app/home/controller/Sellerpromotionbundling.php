            ...
            if (!empty($bundling_list)) {
                ...
                if (!empty($bgoods_array1)) {
                    ...
                    $goods_array = model('goods')->getGoodsList(array(
                        array('goods_id', 'in', $goodsid_array)
    ...
    public function bundling_renew()
    {
        if (request()->isPost()) {
            ...
            if ($return) {
                // 添加任务队列
                $this->addcron(array(
                    'cron_exetime' => $update['blquota_endtime'],
                    'cron_value' => serialize(session('store_id')),
                    'cron_type' => 'editBundlingQuotaClose'
                ), true);
        ...
        switch (request()->action()) {
            ...
            case 'bundling_quota_add':
                $menu_array = array(
                    ...
                    array(
                        'name' => 'bundling_quota_add',
                        'text' => lang('bundling_quota_add'),
