        ...
        switch ($menu_name) {
            ...
            case 'modify_pwd':
                $menu_array = array(
                    ...
                    array(
                        'name' => 'modify_pwd',
                        'text' => lang('change_login_password'),
            ...
            case 'modify_email':
                $menu_array = array(
                    ...
                    array(
                        'name' => 'modify_email',
                        'text' => lang('email_address_verification'),
            ...
            case 'modify_paypwd':
                $menu_array = array(
                    ...
                    array(
                        'name' => 'modify_paypwd',
                        'text' => lang('set_payment_password'),
