...
class Statgeneral extends AdminControl
{
    ...
    protected function getAdminItemList()
    {
        $menu_array = array(
            array(
                'name' => 'general',
                'text' => lang('stat_generalindex'),
                'url' => (string)url('Statgeneral/general')
            ),
            array(
                'name' => 'setting',
                'text' => lang('stat_goodspricerange'),
                'url' => (string)url('Statgeneral/setting')
            ),
            array(
                'name' => 'orderprange',
                'text' => lang('stat_orderpricerange'),
                'url' => (string)url('Statgeneral/orderprange')
            )
        );
        return $menu_array;
    }
