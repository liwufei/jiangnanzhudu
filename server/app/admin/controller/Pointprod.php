...
class Pointprod extends AdminControl
{
    ...
    protected function getAdminItemList()
    {
        $menu_array = array(
            array(
                'name' => 'index',
                'text' => lang('admin_pointprod_list_title'),
                'url' => (string) url('Pointprod/index')
            ),
            array(
                'name' => 'prod_add',
                'text' => lang('admin_pointprod_add_title'),
                'url' => (string) url('Pointprod/prod_add')
            ),
        );
        if (request()->action() == 'prod_edit') {
            $menu_array[] = array(
                'name' => 'prod_edit',
                'text' => lang('admin_pointprod_edit_title'),
                'url' => 'javascript:void()'
            );
        }
