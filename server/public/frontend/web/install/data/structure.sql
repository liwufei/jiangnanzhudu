...
CREATE TABLE `activity` (
  ...
  `act_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '活动类型 默认0 ',
  ...
  `is_finish` tinyint NOT NULL DEFAULT 0 COMMENT '活动状态 默认0 0未开始 1进行中 2已结束',
  `purchase_num` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '限购数量',
  `status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '审核状态 默认0 0待审核 1已审核 2审核不通过',
  `is_recommend` tinyint NOT NULL DEFAULT 0 COMMENT '活动是否推荐 默认0 0未推荐 1已推荐',
  `create_user_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建人用户id',
  ...
  `use_range` tinyint NOT NULL DEFAULT 0,
...
CREATE TABLE `activity_category` (
  ...
  `cat_level` tinyint UNSIGNED NOT NULL DEFAULT 1 COMMENT '分类层级 默认1',
...
CREATE TABLE `admin` (
  ...
  `user_type` tinyint NOT NULL DEFAULT 0 COMMENT '管理员类型 0-平台管理员 1-站点管理员不能为空。',
  ...
  `tel` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '固话',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态',
  `visit_count` int NOT NULL DEFAULT 0 COMMENT '登录次数',
  `valid_time` int NOT NULL COMMENT '有效截止时间 时间戳',
  `valid_time_format` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '格式化的有效截止时间 yyyy-mm-dd hh:ii',
  `last_time` timestamp NULL DEFAULT NULL COMMENT '最后访问时间',
  `last_ip` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '最后登录IP',
  `access_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '授权认证只能包含至多200个字符。',
  `auth_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'KpAvMncqYwUElRq9' COMMENT '授权Key只能包含至多200个字符。',
  `auth_codes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '授权项 超级为all必须是一条字符串。',
  `ec_salt` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '混淆码只能包含至多10个字符。',
...
CREATE TABLE `admin_auth_node` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `auth_id` int NOT NULL COMMENT '权限节点id',
  `auth_group` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '权限节点组',
  `node_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '权限节点路径',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `admin_log` (
  ...
  `admin_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '操作者用户名',
  `admin_id` int NOT NULL COMMENT '操作者用户id',
...
CREATE TABLE `admin_node` (
  ...
  `is_show` tinyint NOT NULL DEFAULT 1 COMMENT '状态 1开启 0关闭',
  `sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `admin_role` (
  ...
  `role_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '权限组名称',
  `auth_codes` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '权限内容',
  `role_desc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '权限组描述',
  `sort` int NOT NULL DEFAULT 255 COMMENT '排序',
  `role_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT 'role_type',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `article` (
  ...
  `cat_model` tinyint UNSIGNED NOT NULL COMMENT '展示形式',
  `cat_type` tinyint NOT NULL DEFAULT 0 COMMENT '分类类型',
  ...
  `is_comment` tinyint NOT NULL DEFAULT 1 COMMENT '是否允许评论',
  ...
  `sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '审核状态 0未审核 1已通过 2未通过',
  ...
  `live_status` tinyint NOT NULL DEFAULT '0' COMMENT '直播状态 0-未直播 1-直播中 2-直播关闭',
  `push_stream` varchar(255) DEFAULT NULL COMMENT '推流地址',
  `pull_stream` varchar(500) DEFAULT NULL COMMENT '拉流地址',
  `article_type` tinyint NOT NULL DEFAULT '0' COMMENT '文章类型 1-帖子 2-视频 3-直播',
  `start_time` timestamp NULL DEFAULT NULL COMMENT '直播开始时间',
  `end_time` timestamp NULL DEFAULT NULL COMMENT '直播结束时间',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `article_cat` (
  ...
  `cat_model` tinyint UNSIGNED NOT NULL COMMENT '展示形式 1单网页展示 2普通展示',
  `cat_type` tinyint UNSIGNED NOT NULL COMMENT '分类类型',
  `cat_level` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '分类等级',
...
CREATE TABLE `attr_value` (
  `attr_vid` int UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `attr_vsort` tinyint UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
...
CREATE TABLE `attribute` (
  ...
  `attr_name` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '属性名称',
  `attr_remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '属性描述',
  `is_index` tinyint NOT NULL DEFAULT 0 COMMENT '是否检索',
  `is_show` tinyint NOT NULL DEFAULT 0 COMMENT '是否显示',
  `attr_style` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '属性样式 默认0 0多选 1单选 2文本',
  `attr_values` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '属性值',
  `attr_sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `shop_id` int UNSIGNED NULL DEFAULT 0 COMMENT 'Shop id',
  `par_attr_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '上级属性或规格ID',
  `is_spec` tinyint NOT NULL DEFAULT 0 COMMENT '是否规格',
  `is_linked` tinyint NOT NULL DEFAULT 0 COMMENT '是否链接',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `back_log` (
  ...
  `record_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '订单商品表主键id',
...
CREATE TABLE `back_order` (
  ...
  `is_after_sale` tinyint NOT NULL DEFAULT 0 COMMENT '是否售后 默认0 0售前 1售后',
  `update_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  `negative_id` int NOT NULL DEFAULT 0 COMMENT '负账单ID',
  `return_rate_price` decimal(10, 2) NOT NULL COMMENT '退税金额',
  `chargeoff_status` tinyint NOT NULL DEFAULT 0 COMMENT '账单 (0:未结账 1:已出账 2:已结账单)',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `bonus` (
  ...
  `is_original_price` tinyint NOT NULL DEFAULT 1 COMMENT '仅限原价购买时使用 0-可与其他优惠、活动一起使用 1-仅限原价购买时使用',
...
CREATE TABLE `brand` (
  ...
  `brand_name` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '品牌名称',
  `brand_letter` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '品牌首字母',
  `site_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '品牌网址',
  `brand_logo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '品牌logo',
  `brand_banner` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '品牌banner图',
  `promotion_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '品牌推广图',
  `brand_desc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '品牌描述',
  `is_show` tinyint NOT NULL DEFAULT 1 COMMENT '是否显示',
  `is_recommend` tinyint NOT NULL DEFAULT 0 COMMENT '是否推荐',
  `brand_apply` tinyint NOT NULL DEFAULT 0 COMMENT '审核是否通过',
  `brand_sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `brand_category` (
  ...
  `cat_id` int UNSIGNED NOT NULL COMMENT '商品分类id',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`bc_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='品牌分类表';
...
CREATE TABLE `cart` (
  ...
  `cart_act_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品活动id 默认0 无活动',
  ...
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '添加时间',
  `select` tinyint NOT NULL DEFAULT 1 COMMENT '购物车选中状态',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `cat_attribute` (
  `cat_attr_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `cat_id` int UNSIGNED NOT NULL COMMENT '商品分类id',
  `attr_id` int UNSIGNED NOT NULL COMMENT '属性规格id',
  `is_required` tinyint NOT NULL DEFAULT 0 COMMENT '是否必填',
  `is_show` tinyint NOT NULL DEFAULT 1 COMMENT '是否显示',
  `is_default` tinyint NOT NULL DEFAULT 1 COMMENT '是否默认',
  `is_input` tinyint NOT NULL DEFAULT 0 COMMENT '是否允许输入平台方未提供的规格',
  `is_alias` tinyint NOT NULL DEFAULT 0 COMMENT '是否启用别名 启用后此规格的名称可以被店铺修改',
  `is_spec` tinyint NOT NULL DEFAULT 0 COMMENT '是否规格 0属性 1规格',
  `is_desc` tinyint NOT NULL DEFAULT 0 COMMENT '是否可以为规格添加备注',
  `is_filter` tinyint NOT NULL DEFAULT 0 COMMENT '是否作为筛选条件展示',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='分类属性规格表';
...
CREATE TABLE `category` (
  `cat_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `cat_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '分类名称',
  `parent_id` smallint UNSIGNED NOT NULL DEFAULT 0 COMMENT '上级分类，商品分类最多支持三级',
  `cat_level` smallint NOT NULL DEFAULT 1 COMMENT '分类级别',
  `cat_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '分类图标',
  `cat_name_pinyin_short` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '分类名称拼音首字母简写',
  `cat_name_pinyin` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '分类名称全拼',
  `ext_info` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '分类扩展字段',
  `cat_desc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '分类描述',
  `take_rate` decimal(5, 2) UNSIGNED NOT NULL COMMENT '佣金比例',
  `sync_take_rate` tinyint NOT NULL DEFAULT 0 COMMENT '佣金比例是否关联到子分类',
  `show_mode` smallint UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品列表页商品展示方式',
  `is_parent` tinyint NOT NULL DEFAULT 0 COMMENT '是否允许新增下级分类',
  `is_show` tinyint NULL DEFAULT 1 COMMENT '是否显示',
  `show_virtual` tinyint NOT NULL DEFAULT 0 COMMENT '是否允许发布虚拟商品',
  `sync_show_virtual` tinyint NOT NULL DEFAULT 0 COMMENT '发布虚拟商品是否关联到子分类',
  `link_type` smallint UNSIGNED NOT NULL DEFAULT 0 COMMENT '链接类型',
  `cat_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '分类链接',
  `image_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `cat_sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `brand_ids` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '关联品牌ids',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'seo title',
  `keywords` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'seo keywords',
  `discription` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'seo discription',
  `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '分类code',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`cat_id`) USING BTREE
...
CREATE TABLE `chat_message` (
    ...
    `scene_id` int UNSIGNED NOT NULL DEFAULT '0' COMMENT '业务场景 1-普通消息 2-邀请同行 3-私信消息 4-直播弹幕',
...
CREATE TABLE `collect` (
  ...
  `collect_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '收藏类型 默认0 0商品收藏 1店铺收藏 2品牌收藏',
  `goods_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品id',
  `sku_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品SKU id',
  ...
  `is_buyed` tinyint NOT NULL DEFAULT 0 COMMENT '是否购买过',
  `shop_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺id',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '收藏时间',
  `collect_from` tinyint UNSIGNED NOT NULL DEFAULT 1 COMMENT '收藏来源 1PC端 2微信端 3Android端 4IOS端',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `compare` (
  `compare_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '会员id',
  `goods_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品id',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `contract` (
  ...
  `contract_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '保障类型',
  `contract_desc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '保障服务描述',
  `is_open` tinyint NOT NULL DEFAULT 1 COMMENT '是否开启',
  `contract_sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`contract_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='保障服务表';
...
CREATE TABLE `copyright_auth` (
  ...
  `is_show` tinyint NOT NULL DEFAULT 0 COMMENT '是否显示',
  `auth_sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`auth_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='资质表';
...
CREATE TABLE `custom_form_data` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `form_id` int NOT NULL DEFAULT 0 COMMENT '表单id',
  `user_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '会员id',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会员表单表';
...
CREATE TABLE `custom_form_template` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会员表单模板表';
...
CREATE TABLE `customer` (
  ...
  `shop_id` int UNSIGNED NOT NULL COMMENT '店铺id',
  `type_id` int UNSIGNED NOT NULL COMMENT '客服类型id',
  `customer_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '客服名称',
  `customer_tool` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '客服工具 默认0 1QQ 2旺旺 3翼客服',
  `customer_account` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '客服账号',
  `is_main` tinyint NOT NULL DEFAULT 0 COMMENT '是否主客服',
  `is_show` tinyint NOT NULL DEFAULT 1 COMMENT '是否显示',
  `customer_sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `customer_type` (
  ...
  `is_show` tinyint NOT NULL DEFAULT 1 COMMENT '是否显示',
  `type_sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `default_search` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `search_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '搜索类型 0默认 1商品分类',
  `type_id` int UNSIGNED NULL DEFAULT NULL COMMENT '分类id',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='默认搜索词表';
...
CREATE TABLE `delivery_goods` (
  ...
  `goods_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品id',
  `sku_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品SKU id',
  `send_number` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '发货数量',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='发货单商品表';
...
CREATE TABLE `delivery_order` (
  ...
  `order_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '订单id',
  `user_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '买家id',
  `shipping_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '物流公司id',
  ...
  `shipping_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '新配送方式 0 无需物流 1 指派 2 众包 3 第三方物流',
  `delivery_charge` decimal(10, 2) NOT NULL COMMENT 'delivery_charge',
  `sender_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '发货店铺id',
  ...
  `delivery_status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '发货单状态 0-待发货 1-已发货 2-发货中 3-已提交物流系统',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '发货单添加时间',
  ...
  `is_arrived` tinyint NOT NULL DEFAULT 0 COMMENT 'is arrived 默认0',
...
CREATE TABLE `deposit_account` (
  ...
  `is_default` tinyint NOT NULL DEFAULT 0 COMMENT '是否默认提现账户 默认0 0-否 1-是',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='会员提现账户表';
...
CREATE TABLE `failed_jobs` (
  ...
  `failed_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='失败队列表';
...
CREATE TABLE `form` (
  ...
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '添加时间',
  `update_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  `is_publish` tinyint NOT NULL DEFAULT 0 COMMENT '是否发布 0-否 1-是',
...
CREATE TABLE `freight` (
  `freight_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `shop_id` int UNSIGNED NOT NULL COMMENT '商家编号',
  `freight_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '运费模板类型 默认0 0全国运费模板 1同城运费模板',
  ...
  `is_free` tinyint NOT NULL DEFAULT 0 COMMENT '是否包邮 0自定义运费 1卖家承担运费',
  `valuation` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '计价方式 0件数 1重量 2体积',
  `limit_sale` tinyint NOT NULL DEFAULT 0 COMMENT '是否支持区域限售 0不支持 1支持',
  `free_set` tinyint NOT NULL DEFAULT 0 COMMENT '是否指定条件包邮 0否 1是',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '添加时间',
  `last_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '修改时间',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`freight_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='运费表';
...
CREATE TABLE `freight_free_record` (
  ...
  `freight_id` int UNSIGNED NOT NULL COMMENT '运费模板id',
  `is_default` tinyint NOT NULL DEFAULT 0 COMMENT '是否默认运费 0否 1是',
  ...
  `free_money` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '包邮条件 满多少元',
  `free_number` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '包邮条件 满多少件',
  `free_mode` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '包邮模式 0件数 1金额 2件数+金额 3件数或金额',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '添加时间',
  `last_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '修改时间',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`record_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='包邮表';
...
CREATE TABLE `freight_record` (
  ...
  `start_num` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '首体积 不能小于0.1 必须不大于9999.9',
  `start_money` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '首费',
  `plus_num` int UNSIGNED NOT NULL DEFAULT 1 COMMENT '续件',
  `plus_money` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '续费',
  `is_cash` tinyint NOT NULL DEFAULT 0 COMMENT '是否支持货到付款 0否 1是',
  `cash_more` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '货到付款加价',
  `sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '添加时间',
  `last_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '修改时间',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`record_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='运费记录表';
...
CREATE TABLE `goods` (
  ...
  `cat_id1` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品一级分类',
  `cat_id2` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品二级分类',
  `cat_id3` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品三级分类',
  `shop_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺ID',
  `sku_open` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Sku Open',
  `sku_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Sku Id',
  `sku_mode` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT 'SKU 模式',
  `prop_open` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '属性开关',
  `street_sort` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺街排序',
  ...
  `warn_number` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '库存警告数量',
  ...
  `top_layout_id` smallint UNSIGNED NOT NULL DEFAULT 0 COMMENT '顶部模板',
  `bottom_layout_id` smallint UNSIGNED NOT NULL DEFAULT 0 COMMENT '底部模板',
  `packing_layout_id` smallint UNSIGNED NOT NULL DEFAULT 0 COMMENT '包装清单版式',
  `service_layout_id` smallint UNSIGNED NOT NULL DEFAULT 0 COMMENT '售后保证版式',
  `click_count` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品浏览次数',
  ...
  `invoice_type` tinyint NOT NULL DEFAULT 0 COMMENT '发票类型 默认 0 0无 1增值税普通发票 2增值税专用发票 3增值税普通发票 和 增值税专用发票选择“无”则将不提供发票',
  `is_repair` tinyint NOT NULL DEFAULT 0 COMMENT '是否保修',
  `user_discount` tinyint NOT NULL DEFAULT 0 COMMENT '会员打折',
  `stock_mode` tinyint NOT NULL DEFAULT 0 COMMENT '库存计数 0拍下减库存 1付款减库存 2出库减库存',
  `comment_num` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品评论次数',
  `sale_num` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品销售数量',
  `multi_store_sale_num` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '门店销量',
  `collect_num` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品收藏数量',
  `goods_audit` tinyint NOT NULL DEFAULT 0 COMMENT '审核是否通过 默认0 0-待审核 1-审核通过 2-审核未通过',
  `goods_status` tinyint NOT NULL DEFAULT 0 COMMENT '商品状态 默认1 0-已下架(定时发布) 1-出售中(立即发布) 2-违规下架(放入仓库)',
  ...
  `is_virtual` tinyint NOT NULL DEFAULT 0 COMMENT '是否虚拟商品',
  ...
  `is_promote` tinyint NOT NULL DEFAULT 0 COMMENT '是否促销',
  `tag_id` int NOT NULL DEFAULT 0 COMMENT '标签id',
  `shipper_id` int NOT NULL DEFAULT 0 COMMENT '商品发货方ID',
  `contract_ids` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '保障服务',
  `supplier_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '供货商ID',
  `freight_id` smallint UNSIGNED NOT NULL DEFAULT 0 COMMENT '运费模板',
  `goods_freight_type` tinyint NOT NULL DEFAULT 0 COMMENT '运费设置',
  ...
  `goods_sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '商品排序',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品发布时间',
  `last_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '最后一次更新时间',
  `audit_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品审核时间',
  `edit_items` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '更多商品编辑项',
  `act_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '活动id 默认0 0无活动',
  `goods_moq` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '最小起订量',
  `lib_goods_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品库商品id',
  ...
  `pricing_mode` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '计价方式 默认0 0计件 1计重',
  `goods_unit` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品单位',
  `sales_model` tinyint NOT NULL DEFAULT 0 COMMENT '销售模式 默认0 0零售 1批发',
  `sales_area` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '销售区域',
  ...
  `erp_goods_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT 'erp_goods_id',
  `goods_from` char(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '商品来源',
  `is_cross_border` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否跨境商品',
  `is_sync_stock` tinyint NOT NULL DEFAULT 0 COMMENT 'is_sync_stock',
  `is_sync_price` tinyint NOT NULL DEFAULT 0 COMMENT 'is_sync_price',
  `is_sync_onoff` tinyint NOT NULL DEFAULT 0 COMMENT 'is_sync_onoff',
  `cs_dg_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT 'cs_dg_id',
  `is_pickup` tinyint NOT NULL DEFAULT 0 COMMENT '是否自提',
  `is_common_package` tinyint NOT NULL DEFAULT 0 COMMENT '是否普通快递',
  `pickup_timeout` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品自提超时期限',
  `pickup_timeout_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品自提超时期限类型 0-分钟 1-小时 2-天',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `goods_activity` (
  ...
  `act_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '活动表主键id',
  `sku_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品SKU ID',
  `act_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '活动类型 默认0 ',
  `goods_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品id',
  `cat_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '活动分类id',
  `sale_base` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '销量基数',
  `act_price` decimal(10, 2) NOT NULL COMMENT '活动价格',
  `act_stock` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '活动库存',
  `is_enable` tinyint NOT NULL DEFAULT '0' COMMENT '是否有效 0-已取消 1-有效',
  `ext_info` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '扩展字段',
  `sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品活动表';
...
CREATE TABLE `goods_attr` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `goods_id` int UNSIGNED NOT NULL COMMENT '商品SPU id',
...
CREATE TABLE `goods_comment` (
  ...
  `user_rank_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '会员等级id',
  `site_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '站点id',
  `shop_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺id',
  `order_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '订单id',
  `goods_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品id',
  `sku_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品SKU id',
  `desc_mark` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '描述相符 默认0',
  ...
  `is_anonymous` tinyint NOT NULL DEFAULT 0 COMMENT '是否匿名评价 默认0',
  `comment_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '评价时间',
  `comment_status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '评价状态 默认0 0待审核 1审核通过 2审核拒绝',
  `is_show` tinyint NOT NULL DEFAULT 0 COMMENT '是否显示评价 默认0 0不显示 1显示',
  ...
  `add_is_anonymous` tinyint NOT NULL DEFAULT 0 COMMENT '是否匿名追加评价 默认0',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '追加评价时间',
  `add_status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '追加评价状态 默认0 0待审核 1审核通过 2审核拒绝',
  `add_is_show` tinyint NOT NULL DEFAULT 0 COMMENT '是否显示追加评价 默认0 0不显示 1显示',
  `seller_reply_desc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '卖家回复内容',
  `seller_reply_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '卖家回复时间',
  `user_reply_desc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '买家回复内容',
  `user_reply_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '买家回复时间',
  `is_delete` tinyint NOT NULL DEFAULT 0 COMMENT '是否删除 默认0 0正常 1已删除',
  `evaluate_status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '评价状态 默认0 待评价 1初次评价完成 2追加评价完成',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `goods_history` (
  ...
  `look_time` int NOT NULL DEFAULT 0 COMMENT '当前登录用户查看时间',
  `look_count` int NOT NULL DEFAULT 0 COMMENT '当前登录用户查看次数',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`history_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品历史价格表';
...
CREATE TABLE `goods_layout` (
  ...
  `position` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '模板位置',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板内容',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`layout_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品布局表';
...
CREATE TABLE `goods_sku` (
  ...
  `goods_number` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品库存',
  `sku_number_version` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品SKU库存数量版本号 默认0',
  `goods_sn` char(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '商品货号',
  `goods_barcode` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '商品条形码 支持一品多码，多个条形码之间用逗号分隔',
  `warn_number` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '库存警告数量',
  `goods_stockcode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '商品库位码',
  ...
  `pc_desc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '商品电脑端描述',
  `mobile_desc` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '商品手机端描述',
  `is_spu` tinyint NOT NULL DEFAULT 1 COMMENT '是否SPU 默认1',
  `checked` tinyint NOT NULL DEFAULT 1 COMMENT '是否可用 默认1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `goods_spec` (
  ...
  `goods_id` int UNSIGNED NOT NULL COMMENT '商品SPU id',
  `attr_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '规格id',
  `attr_vid` int UNSIGNED NOT NULL COMMENT '规格值id',
  `cat_id` int UNSIGNED NOT NULL COMMENT '商品分类id',
  ...
  `is_checked` tinyint NOT NULL DEFAULT 0 COMMENT '是否选中 默认否',
  `spec_sort` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '排序',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `goods_type` (
  `type_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `type_name` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '类型名称',
...
CREATE TABLE `groupon_log` (
   ...
   `deleted_at` timestamp NULL DEFAULT NULL,
   PRIMARY KEY (`log_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='拼团日志表';
...
CREATE TABLE `image` (
  ...
  `size` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '图片大小',
...
CREATE TABLE `image_dir` (
  ...
  `is_default` tinyint NOT NULL DEFAULT 0 COMMENT '是否默认相册',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`dir_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='图片目录表';
...
CREATE TABLE `integral_goods`  (
  `goods_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `shop_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺id 当平台开启店铺积分商城时才有值',
  `goods_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品名称',
  `goods_price` decimal(10, 2) NOT NULL COMMENT '商品价格',
  `market_price` decimal(10, 2) NOT NULL COMMENT '市场价格（组合价格）',
  `goods_number` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '可兑换商品库存',
  `goods_integral` int UNSIGNED NOT NULL COMMENT '所需积分',
  `exchange_number` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '已兑换量',
  ...
  `collect_num` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '收藏量',
  `goods_sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '商品排序',
  `is_delete` tinyint NOT NULL DEFAULT 0 COMMENT '是否删除',
  `goods_status` tinyint UNSIGNED NOT NULL DEFAULT 1 COMMENT '商品状态 默认1 1出售中 0已下架',
  `erp_goods_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT 'erp 商品id',
  `is_limit` tinyint NOT NULL DEFAULT 0 COMMENT '限制兑换时间 默认0 1限制 0不限制',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`goods_id`) USING BTREE
...
CREATE TABLE `integral_order_goods` (
  `record_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `order_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '订单id',
  `goods_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '积分商品id',
  ...
  `stock_dropped` tinyint NOT NULL DEFAULT 0 COMMENT '库存是否已减 默认0 0未减库存 1已减库存',
  `goods_contracts` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `is_delete` tinyint NOT NULL DEFAULT 0 COMMENT '是否删除 默认0',
  `order_status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '订单状态 默认0 ',
  `goods_integral` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '所需积分',
  `goods_stock` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品库存',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`record_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='积分订单商品表';
...
CREATE TABLE `integral_order_info` (
  ...
  `user_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '买家id',
  `order_status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '订单状态 默认0 0shipped发货中 1finished交易成功',
  `site_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '站点id',
  `shop_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺id',
  ...
  `receiving_mode` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '收货方式 默认0',
  ...
  `shipping_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '发货时间 默认0',
  `confirm_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '确认收货时间 默认0',
  `delay_days` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '延迟收货天数 默认0 0正常收货',
  `order_type` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '交易类型 默认0',
  ...
  `buyer_type` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '买家类型 默认0',
  ...
  `order_points` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '订单积分 默认0',
  ...
  `buy_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT 'buy_type 默认0 ',
...
CREATE TABLE `lib_category` (
  ...
  `parent_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '上级分类',
  `is_show` tinyint NOT NULL DEFAULT 0 COMMENT '是否显示',
  `cat_sort` smallint UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`cat_id`) USING BTREE
...
CREATE TABLE `lib_goods` (
  ...
  `last_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '最后一次更新时间',
  `act_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '活动id 默认0 0无活动',
  `lib_cat_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '系统商品分类id',
  `other_attrs` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '店铺自定义属性',
  `pricing_mode` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '计价方式 默认0 0计件 1计重',
  `goods_unit` int UNSIGNED NULL DEFAULT NULL COMMENT '商品单位',
  `tag_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品标签',
  `sales_model` tinyint NOT NULL DEFAULT 0 COMMENT '销售模式 默认0 0零售 1批发',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`goods_id`) USING BTREE
...
CREATE TABLE `lib_goods_attr` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统商品属性表';
...
CREATE TABLE `lib_goods_image` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`img_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统商品图片表';
...
CREATE TABLE `lib_goods_sku` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`sku_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统商品SKU表';
...
CREATE TABLE `lib_goods_spec` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`spec_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统商品规格表';
...
CREATE TABLE `lib_spec_alias` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `goods_id` int UNSIGNED NOT NULL COMMENT '商品SPU id',
  `attr_id` int UNSIGNED NOT NULL COMMENT '规格id',
  `attr_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '规格别名值',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统规格别名表';
...
CREATE TABLE `links` (
  `links_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `is_show` tinyint NOT NULL DEFAULT 1 COMMENT '是否显示',
  `links_sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `live` (
  ...
  `start_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '直播开始时间',
  `end_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '直播结束时间',
  ...
  `sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `online_number` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '在线数量',
  `view_number` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '关注人数',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='直播表';
...
CREATE TABLE `live_auth` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='直播权限表';
...
CREATE TABLE `mall_account` (
  ...
  `user_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '会员id',
  `admin_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店主id',
  `amount` decimal(10, 2) NOT NULL COMMENT '账户变动金额',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '账户变动时间',
  `note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '名称/备注',
  `account_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '账户分类',
  `pay_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '账户类型',
  `status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '交易订单状态 默认0 0-进行中 1-交易成功 2-交易关闭 3-退款成功',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='平台进出帐明细表';
...
CREATE TABLE `member` (
  ...
  `rank_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺会员等级id',
  `is_enable` tinyint NOT NULL DEFAULT 1 COMMENT '会员状态 默认1 1享受会员折扣 0不享受会员折扣',
...
CREATE TABLE `message` (
  ...
  `sender` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '消息发送者会员id',
  `send_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '消息发送时间',
  ...
  `type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '消息类型 默认0 1-会员消息 2-店铺消息',
...
CREATE TABLE `message_template` (
  ...
  `type` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '模板类型',
  `msg_type` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '消息类型',
  `sys_open` tinyint NOT NULL DEFAULT 1 COMMENT '站内信开关',
  `sms_open` tinyint NOT NULL DEFAULT 1 COMMENT '短信开关',
  `email_open` tinyint NOT NULL DEFAULT 1 COMMENT '邮件开关',
  `wx_open` tinyint NOT NULL DEFAULT 1 COMMENT '微信开关',
  `last_modify` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '最后修改时间',
...
CREATE TABLE `migrations` (
  ...
  `batch` int NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='数据库迁移表';
...
CREATE TABLE `multi_store` (
  ...
  `shop_id` int UNSIGNED NOT NULL COMMENT '店铺id',
  `group_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '门店分组id',
  `store_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '门店名称',
  `user_id` int UNSIGNED NOT NULL COMMENT '会员id',
  `user_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '用户类型 0会员 1店铺管理员',
  ...
  `region_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '销售/配送范围 默认0 0全国模板 1同城模板',
  `region_editable` tinyint NOT NULL DEFAULT 1 COMMENT '是否允许门店修改销售/配送范围',
  `tel` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '门店电话',
  `opening_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '营业时间类型 0全天 1每天重复 2每周重复',
  ...
  `clearing_cycle` tinyint UNSIGNED NOT NULL COMMENT '结算周期 0一个月 1一周 2一天 3三天',
  `pickup_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '自提点id',
  `store_status` tinyint NOT NULL DEFAULT 0 COMMENT '门店状态 默认0',
  `edit_info` tinyint NOT NULL DEFAULT 0 COMMENT '是否允许门店修改基本信息 默认0',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '添加时间',
  ...
  `is_diy` tinyint NOT NULL DEFAULT 0 COMMENT '是否开启门店自定义装修首页',
  `is_master` tinyint NOT NULL DEFAULT 0 COMMENT '主店',
  `store_logo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '门店logo',
  `yl_settle_mode` tinyint UNSIGNED NOT NULL COMMENT '银联结算模式',
  `reserve_money` decimal(10, 2) NOT NULL COMMENT '银联商户预留金额',
  `is_allowed_related_goods` tinyint NOT NULL DEFAULT 0 COMMENT '是否允许门店自主关联商品 默认0 0否 1是',
  ...
  `out_openhour_order_enable` tinyint NOT NULL DEFAULT 0 COMMENT '非营业时间是否支持下单 默认0 0否 1是',
  `close_tips` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '非营业时间下单提示',
  `is_other_shpping_fee` tinyint NOT NULL DEFAULT 0 COMMENT '门店统一额外配送费 默认0 0否 1是',
  `is_packing_fee` tinyint NOT NULL DEFAULT 0 COMMENT '门店统一包装费 默认0 0否 1是',
...
CREATE TABLE `multi_store_goods` (
  ...
  `store_goods_number` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '门店独立库存',
  `is_sell` tinyint NOT NULL DEFAULT 0 COMMENT '商品状态 0-已下架 1-出售中',
  `is_self_mention` tinyint NOT NULL DEFAULT 0 COMMENT '是否开启自提 0-关闭 1-开启',
  `sale_num` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '门店销量',
  `act_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '门店活动ID',
  `order_act_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT 'order_act_id',
...
CREATE TABLE `multi_store_goods_sku` (
  ...
  `shop_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺ID',
  `store_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '门店ID',
  `store_goods_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '门店商品关联ID',
  `goods_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品ID',
  `sku_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品SKU ID',
  `store_sku_price` decimal(10, 2) UNSIGNED NOT NULL COMMENT '门店商品SKU价格',
  `store_sku_number` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '门店商品SKU库存',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='门店商品SKU表';
...
CREATE TABLE `multi_store_group` (
  ...
  `group_sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='门店分组表';
...
CREATE TABLE `nav_ad` (
  ...
  `is_show` tinyint NOT NULL DEFAULT 1 COMMENT '是否显示',
  `ad_sort` tinyint UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='导航ad表';
...
CREATE TABLE `nav_banner` (
  ...
  `is_show` tinyint NOT NULL DEFAULT 1 COMMENT '是否显示',
  `banner_sort` tinyint UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='导航banner表';
...
CREATE TABLE `nav_brand` (
  ...
  `brand_id` int UNSIGNED NOT NULL COMMENT '品牌id',
  `is_show` tinyint NOT NULL DEFAULT 1 COMMENT '是否显示',
  `brand_sort` tinyint UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `category_id` int UNSIGNED NOT NULL COMMENT '首页分类ID 分类导航中的id',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='导航品牌表';
...
CREATE TABLE `nav_quick_service` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='导航快捷服务表';
...
CREATE TABLE `nav_words` (
  ...
  `words_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '推荐词类型',
  `new_open` tinyint NOT NULL DEFAULT 1 COMMENT '是否新窗口打开',
  `is_show` tinyint NOT NULL DEFAULT 1 COMMENT '是否显示',
  `words_sort` tinyint UNSIGNED NOT NULL DEFAULT 255 COMMENT '推荐词排序',
  `words_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '推荐词链接',
  `category_id` tinyint UNSIGNED NOT NULL DEFAULT 255 COMMENT '首页分类ID',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='导航推荐词表';
...
CREATE TABLE `navigation` (
  ...
  `nav_position` tinyint UNSIGNED NOT NULL DEFAULT 1 COMMENT '显示位置 默认1 1头部 2中间 3底部',
  `nav_layout` tinyint UNSIGNED NOT NULL DEFAULT 1 COMMENT '布局 默认1 1左侧 2右侧',
  ...
  `is_show` tinyint NOT NULL DEFAULT 1 COMMENT '是否显示',
  `new_open` tinyint NOT NULL DEFAULT 1 COMMENT '新窗口打开',
...
CREATE TABLE `order_action` (
  ...
  `shipping_status` tinyint NOT NULL DEFAULT 0 COMMENT '配送状态',
  `pay_status` tinyint NOT NULL DEFAULT 0 COMMENT '付款状态',
  `action_place` tinyint NOT NULL DEFAULT 0 COMMENT '（取消订单记录，值为1）',
...
CREATE TABLE `order_goods` (
  ...
  `is_gift` tinyint NOT NULL DEFAULT 0 COMMENT '是否礼物商品 默认0',
  `is_evaluate` tinyint NOT NULL DEFAULT 0 COMMENT '是否评价 默认0',
  ...
  `is_distrib` tinyint NOT NULL DEFAULT 0 COMMENT '是否分销商品 默认0',
...
CREATE TABLE `order_info` (
  ...
  `is_cod` tinyint NOT NULL DEFAULT 0 COMMENT '是否为货到付款 0 否 1 是',
  ...
  `end_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '订单终止时间 默认0',
  `is_distrib` tinyint NOT NULL DEFAULT 0 COMMENT '是否为分销商品 0 否 1 是',
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `is_settlement` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '账单结算状态：0 未结算 1 已结算',
  `chargeoff_status` tinyint UNSIGNED NULL DEFAULT 0 COMMENT '账单 (0:未结账 1:已出账 2:已结账单)',
  PRIMARY KEY (`order_id`) USING BTREE
...
CREATE TABLE `order_pay` (
  ...
  `order_amount` decimal(10, 2) UNSIGNED NOT NULL COMMENT '总金额',
  `order_balance` decimal(10, 2) UNSIGNED NOT NULL COMMENT '余额支付',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单结算记录表';
...
CREATE TABLE `payment` (
  ...
  `pay_sort` int NOT NULL DEFAULT 255 COMMENT '排序',
...
CREATE TABLE `print_spec` (
  ...
  `is_default` tinyint NOT NULL DEFAULT 0 COMMENT '是否默认打印机 默认0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `tpl_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '模板数据',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='打印机规格表';
...
CREATE TABLE `programs_qrcode` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='微信小程序码表';
...
CREATE TABLE `push_message` (
  ...
  `push_type` tinyint UNSIGNED NOT NULL DEFAULT 7 COMMENT '推送类型 默认7 0-商品 1-店铺主页 2-文章详情 3-分类商品 4-团购活动 5-品牌专题 6-自定义链接',
  `shop` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺id',
  `article` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '文章id',
  `category` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品分类id',
  `group` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '团购活动id',
  `brand` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '品牌id',
...
CREATE TABLE `qcode` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `qcode_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '二维码类型 0-商品二维码 1-文章二维码',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='微信二维码表';
...
CREATE TABLE `region` (
  ...
  `region_name` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '地区名称',
  `region_code` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '地区代码',
  `parent_code` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '上级区域代码',
  `region_type` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '地区类型',
  `center` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '地区经纬度',
  `city_code` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '城市代码',
  `level` tinyint NOT NULL DEFAULT 0 COMMENT '地区级别',
  `is_enable` tinyint NOT NULL COMMENT '是否启用',
  `is_scope` tinyint NOT NULL DEFAULT 1,
...
CREATE TABLE `self_pickup` (
  ...
  `sort` int NOT NULL DEFAULT 255 COMMENT '排序',
  `is_delete` tinyint NOT NULL DEFAULT 0 COMMENT '删除状态',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`pickup_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='自提点表';
...
CREATE TABLE `self_shop` (
  ...
  `is_supply` tinyint NOT NULL DEFAULT 0 COMMENT '是否供应',
  ...
  `address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '详细地址',
  `show_price` tinyint NOT NULL DEFAULT 1 COMMENT '店铺价格是否显示',
  ...
  `shop_type` tinyint UNSIGNED NULL DEFAULT NULL COMMENT '店铺类型',
  ...
  `goods_status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺商品是否需要审核',
  `show_credit` tinyint NOT NULL DEFAULT 1 COMMENT '是否显示店铺信誉',
  `login_status` tinyint NOT NULL DEFAULT 1 COMMENT '是否允许登录卖家中心',
  `goods_is_show` tinyint NOT NULL DEFAULT 1 COMMENT '店铺商品能否在商城展示',
  `show_in_street` tinyint NOT NULL DEFAULT 1 COMMENT '店铺能否在商城展示',
  `shop_status` tinyint NOT NULL DEFAULT 0 COMMENT '店铺状态',
...
CREATE TABLE `seller_account` (
  `account_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `account_sn` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '流水号',
  `user_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '订单买家id',
  `admin_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店主id',
  `amount` decimal(10, 2) NOT NULL COMMENT '账户变动金额',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '账户变动时间',
  `note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '名称/备注',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`account_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺进出帐明细表';
...
CREATE TABLE `seller_bill_goods` (
  ...
  INDEX `goods_id`(`goods_id`) USING BTREE,
  INDEX `cat_id`(`cat_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品账单商品表';
...
CREATE TABLE `seller_commission_bill` (
  ...
  `commission_model` tinyint NOT NULL DEFAULT -1 COMMENT '佣金模式（0：按商家比例 1：按平台分类比例）',
  ...
  `start_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '开始时间',
  `end_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '结束时间',
  `chargeoff_status` tinyint NOT NULL DEFAULT 0 COMMENT '出账状态 0:未出账 1:已出账 2:账单结束 3:关闭账单',
  `bill_cycle` tinyint NOT NULL DEFAULT 2 COMMENT '账单结算周期类型',
  `bill_apply` tinyint NOT NULL DEFAULT 0 COMMENT '商家申请账单 (0:未申请 1:已申请)',
  ...
  `check_status` tinyint NOT NULL DEFAULT 0 COMMENT '审核账单状态（0：待处理 1：同意 2：拒绝）',
...
CREATE TABLE `seller_negative_bill` (
  ...
  `shop_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商家ID',
  `return_amount` decimal(10, 2) UNSIGNED NOT NULL COMMENT '负账单总金额',
  `return_shippingfee` decimal(10, 2) UNSIGNED NOT NULL COMMENT '负账单退款总金额',
...
CREATE TABLE `seller_negative_order` (
  ...
  `return_amount` decimal(10, 2) UNSIGNED NOT NULL COMMENT '退款金额',
  `return_rate_price` decimal(10, 2) NOT NULL COMMENT '跨境税费退款金额',
  `return_shippingfee` decimal(10, 2) UNSIGNED NOT NULL COMMENT '退运费金额',
...
CREATE TABLE `sheet_config` (
  `sheet_config_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `shipping` (
  ...
  `img_width` int UNSIGNED NULL DEFAULT 0 COMMENT '背景图片宽度',
  `img_height` int UNSIGNED NULL DEFAULT 0 COMMENT '背景图片高度',
  `offset_top` int UNSIGNED NULL DEFAULT 0 COMMENT '上偏移量',
  `offset_left` int UNSIGNED NULL DEFAULT 0 COMMENT '左偏移量',
  `img_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '模板图片',
  `is_open` tinyint NOT NULL DEFAULT 0 COMMENT '平台方是否开启此快递 0-否 1-是',
  `is_sheet` tinyint NOT NULL DEFAULT 0 COMMENT '是否支持电子面单',
  `is_system` tinyint NOT NULL DEFAULT 0 COMMENT '是否系统默认',
  `shipping_sort` int NOT NULL DEFAULT 255 COMMENT '排序',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='快递公司表';
...
CREATE TABLE `shop` (
  ...
  `is_supply` tinyint NOT NULL DEFAULT 0 COMMENT '是否供货商 0-否 1-是',
  `cat_id` int UNSIGNED NOT NULL COMMENT '店铺分类',
  ...
  `shop_status` tinyint NOT NULL DEFAULT 0 COMMENT '店铺状态 默认0 0关闭 1开启',
  ...
  `show_in_street` tinyint NOT NULL DEFAULT 1 COMMENT '店铺能否在商城展示',
  `goods_is_show` tinyint NOT NULL DEFAULT 1 COMMENT '店铺商品能否在商城展示',
  `control_price` tinyint NOT NULL DEFAULT 1 COMMENT '店铺商品能否control_price',
  `show_price` tinyint NOT NULL DEFAULT 1 COMMENT '店铺价格是否显示',
  `show_content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '店铺价格显示内容',
  `button_content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '购买按钮显示内容',
  ...
  `rebate_enable` tinyint NOT NULL DEFAULT 0 COMMENT '店铺是否开启折扣 默认0 0否 1是',
  ...
  `is_other_shpping_fee` tinyint NOT NULL DEFAULT 0 COMMENT '店铺是否统一额外配送费 默认0 0-否 1-是',
  `other_shipping_fee` decimal(10, 2) NOT NULL COMMENT '额外增加配送费',
  `is_packing_fee` tinyint NOT NULL DEFAULT 0 COMMENT '店铺是否统一包装费 默认0 0-否 1-是',
  ...
  `is_cross_border` tinyint NOT NULL DEFAULT 0 COMMENT 'is_cross_border',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺地址表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺审核表';
...
CREATE TABLE `shop_bill` (
  ...
  `shop_status` tinyint NOT NULL DEFAULT 0 COMMENT '结算状态 0-未出账 2-已出账，待结算 3-已出账，已结算 4-部分账单已出账，已结算',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺结算表';
...
CREATE TABLE `shop_comment` (
  ...
  `shop_is_delete` tinyint NOT NULL DEFAULT 0 COMMENT '是否删除 默认0 0正常 1已删除',
  `shop_is_show` tinyint NOT NULL DEFAULT 0 COMMENT '是否显示评价 默认0 0不显示 1显示',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `shop_config_field` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺配置字段表';
...
CREATE TABLE `shop_contract` (
  ...
  `is_enable` tinyint NOT NULL DEFAULT 1 COMMENT '是否启用 默认启用',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '审核意见',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺保障表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺信誉表';
...
CREATE TABLE `shop_field_value` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺认证表';
...
CREATE TABLE `shop_log` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺日志表';
...
CREATE TABLE `shop_node` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺节点表';
...
CREATE TABLE `shop_payment` (
  ...
  `system_fee` decimal(10, 2) NOT NULL COMMENT '平台使用费',
  `insure_fee` decimal(10, 2) NOT NULL COMMENT '平台保证金',
  `is_frozen` tinyint NOT NULL DEFAULT 0 COMMENT '是否冻结费用 默认0',
  `pay_status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '付款状态 默认0 0未付款 1已付款',
  `is_renew` tinyint NOT NULL DEFAULT 0 COMMENT '是否续费 默认0 0-开店申请付款 1-店铺续费',
  `remark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '备注',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`pay_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺付款表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺问答表';
...
CREATE TABLE `shop_rank` (
  ...
  `is_special` tinyint NOT NULL DEFAULT 0 COMMENT '是否特殊会员级别 默认0',
...
CREATE TABLE `shop_role` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`role_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺角色表';
...
CREATE TABLE `shop_shipper` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺发货方表';
...
CREATE TABLE `shop_shipping` (
  ...
  `offset_left` int UNSIGNED NULL DEFAULT 0 COMMENT '左偏移量',
  `img_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '模板图片',
  `is_default` tinyint NOT NULL DEFAULT 0 COMMENT '是否默认 默认0',
  `is_open` tinyint NOT NULL DEFAULT 0 COMMENT '是否启用 默认0',
  `config_lable` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '配置标签',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='店铺快递公司表';
...
CREATE TABLE `sku_member` (
  ...
  `sku_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT 'SKU ID',
  `shop_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺ID',
  `shop_rank_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺会员等级ID',
  `goods_price` decimal(10, 2) NOT NULL COMMENT '商品价格',
  `member_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '优惠类型 默认0 0-打折 1-减价 2-指定价格',
  `member_value` decimal(10, 2) NOT NULL COMMENT '优惠金额或折扣',
...
CREATE TABLE `sms_log` (
  ...
  `log_type` tinyint UNSIGNED NOT NULL DEFAULT 1 COMMENT '短信类型:1为注册,2为登录,3为找回密码,默认为1',
  `user_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '会员id',
  `user_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '会员名',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `spec_alias` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='规格别名表';
...
CREATE TABLE `store` (
  ...
  `store_lng` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '经度',
  `store_lat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '纬度',
  `region_editable` tinyint NOT NULL DEFAULT 1 COMMENT '是否允许网点修改销售/配送范围',
  `group_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '网点分组id',
  `region_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '销售/配送范围 默认0 0全国模板 1同城模板',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '添加时间',
  `is_pickup` tinyint NOT NULL DEFAULT 1 COMMENT '网点是否作为自提点',
  `pickup_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '自提点id',
  `auto_order_taking` tinyint NOT NULL DEFAULT 0 COMMENT '网点是否自动接单 默认0',
  `refuse_order_taking` tinyint NOT NULL DEFAULT 0 COMMENT '网点是否支持拒绝接单 默认0',
  `store_status` tinyint NOT NULL DEFAULT 0 COMMENT '网点状态 默认0',
  `edit_info` tinyint NOT NULL DEFAULT 0 COMMENT '是否允许网点修改基本信息 默认0',
...
CREATE TABLE `sub_site` (
  ...
  `clearing_cycle` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '结算周期',
  `site_admin` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '站点管理员',
  ...
  `end_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '到期时间',
  `site_expenses` decimal(10, 2) NOT NULL COMMENT '站点费用',
  `take_rate` decimal(10, 2) NOT NULL COMMENT '佣金比例',
  `site_qq` int UNSIGNED NOT NULL DEFAULT 0 COMMENT 'QQ客服',
  ...
  `site_status` tinyint NOT NULL DEFAULT 1 COMMENT '是否启用站点',
  `is_default` tinyint NOT NULL DEFAULT 0 COMMENT '是否默认站点',
  `close_reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '关闭原因',
  `site_sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '站点排序',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `system_config` (
  ...
  `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '配置code',
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '配置标题',
  `unit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '配置单位 如：元',
  `group` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '配置分组',
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '表单类型',
  `required` tinyint NOT NULL DEFAULT 0 COMMENT '字段是否必须 0非必须 1必须',
  `anchor` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '页面导航',
...
CREATE TABLE `template` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `tpl_client` int NOT NULL,
  `tpl_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板名称',
...
CREATE TABLE `template_cat` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `tpl_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板code',
  `selector_type` int NOT NULL COMMENT '模板选择器id',
  `cat_id` int NOT NULL DEFAULT 1 COMMENT '模板分类id',
  `number` int NOT NULL COMMENT 'item数量',
  `width` int NOT NULL COMMENT '图片宽度',
  `height` int NOT NULL COMMENT '图片高度',
  `explain_msg` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '温馨提示信息',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `template_item` (
  ...
  `sort` int NOT NULL COMMENT '排序',
  `tpl_id` int NULL DEFAULT NULL,
  `tpl_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uid`(`uid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='模板项表';
...
CREATE TABLE `template_page` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板code',
  `page` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板页面类型 site topic news',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='模板页面表';
...
CREATE TABLE `template_selector` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `selector_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板选择器名称',
  `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板选择器code',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='模板选择器表';
...
CREATE TABLE `tpl_backup` (
  ...
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '添加时间',
  `is_sys` tinyint NOT NULL DEFAULT 0 COMMENT '是否为系统预置模板',
  `shop_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺id',
  `site_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '站点id',
  ...
  `type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-模板及数据 1-仅备份模板',
  ...
  `is_theme` tinyint NOT NULL DEFAULT 0 COMMENT '是否设为主题',
  `ext_info` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '扩展信息',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`back_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='模板备份表';
...
CREATE TABLE `trade_snapshot` (
  `trade_id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `order_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '订单ID',
  ...
  `goods_number` int UNSIGNED NOT NULL DEFAULT 1 COMMENT '商品数量',
  ...
  `ru_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商家id',
  ...
  `snapshot_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '快照新增时间',
  ...
  INDEX `goods_id`(`goods_id`) USING BTREE,
  INDEX `ru_id`(`ru_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='交易快照表';
...
CREATE TABLE `user` (
  `user_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `role_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '角色id 默认0',
  ...
  `rank_id` tinyint UNSIGNED NOT NULL COMMENT '等级id',
  `rank_point` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '成长值',
  `use_between` tinyint NOT NULL DEFAULT 0 COMMENT '享受时长 是否有限 0无限期 1有限',
  `rank_start_time` date NULL DEFAULT NULL COMMENT '开始时间',
  `rank_end_time` date NULL DEFAULT NULL COMMENT '结束时间',
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '密码',
  `sex` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '性别默认0 0保密 1男 2女',
  ...
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '邮箱',
  `status` tinyint NOT NULL DEFAULT 0 COMMENT '是否允许登录 默认0 0否 1是',
  `shopping_status` tinyint NOT NULL DEFAULT 0 COMMENT '是否允许购物 默认0 0否 1是',
  `comment_status` tinyint NOT NULL DEFAULT 0 COMMENT '是否允许评论 默认0 0否 1是',
  ...
  `visit_count` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '登录次数',
  `is_real` tinyint NOT NULL DEFAULT 0 COMMENT '是否实名认证默认0 0否 1是',
  `reg_time` timestamp NULL DEFAULT NULL COMMENT '注册时间',
  `mobile_validated` tinyint NOT NULL DEFAULT 0 COMMENT '是否已验证手机默认0 0否 1是',
  `email_validated` tinyint NOT NULL DEFAULT 0 COMMENT '是否已验证邮箱默认0 0否 1是',
  ...
  `live_verified` tinyint UNSIGNED DEFAULT '0' COMMENT '主播认证状态 0-未认证 1-已认证 2-认证中 3-已拒绝',
...
CREATE TABLE `user_account` (
  ...
  `account_sn` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '流水号',
  `user_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '会员id',
  `admin_user` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店主id',
  `amount` decimal(10, 2) NOT NULL COMMENT '账户变动金额',
  `cur_balance` decimal(10, 2) NOT NULL COMMENT '当前账户余额',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '账户变动时间',
  `last_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '账户最后变动时间',
  `note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '名称/备注',
  `process_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '账户变动类型',
  `payment_code` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '支付方式id',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户账户明细表';
...
CREATE TABLE `user_address` (
  ...
  `is_default` tinyint NOT NULL DEFAULT 0 COMMENT '是否默认收货地址',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`address_id`) USING BTREE
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户红包表';
...
CREATE TABLE `user_capital` (
  ...
  `account_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '提现账户id',
  `add_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '添加时间',
  `status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '提现申请状态',
  `process_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '提现类型',
...
CREATE TABLE `user_follow` (
   ...
   `user_id` int UNSIGNED NOT NULL DEFAULT '0' COMMENT '用户ID',
   `type` tinyint UNSIGNED NOT NULL DEFAULT '0' COMMENT '类型 1-关注用户',
   `target_id` int UNSIGNED NOT NULL DEFAULT '0' COMMENT '目标ID',
   `created_at` timestamp NULL DEFAULT NULL,
   `updated_at` timestamp NULL DEFAULT NULL,
   `deleted_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `user_praise` (
   `praise_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
   `user_id` int UNSIGNED NOT NULL DEFAULT '0' COMMENT '用户ID',
   `type` tinyint UNSIGNED NOT NULL DEFAULT '0' COMMENT '类型 1-文章点赞',
   `target_id` int UNSIGNED NOT NULL DEFAULT '0' COMMENT '目标ID',
   `created_at` timestamp NULL DEFAULT NULL,
   `updated_at` timestamp NULL DEFAULT NULL,
   `deleted_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `user_collect` (
    `collect_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
    `user_id` int UNSIGNED NOT NULL DEFAULT '0' COMMENT '用户ID',
    `type` tinyint UNSIGNED NOT NULL DEFAULT '0' COMMENT '类型 1-收藏文章',
    `target_id` int UNSIGNED NOT NULL DEFAULT '0' COMMENT '目标ID',
    `created_at` timestamp NULL DEFAULT NULL,
    `updated_at` timestamp NULL DEFAULT NULL,
    `deleted_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `user_log` (
  `log_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '会员id',
  `admin_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '当前登录管理员id',
  `change_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '变更时间',
  `change_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '操作类型',
...
CREATE TABLE `user_points_log` (
  ...
  `changed_points` int NOT NULL DEFAULT 0 COMMENT '变更积分',
...
CREATE TABLE `user_rank` (
  ...
  `is_special` tinyint NOT NULL DEFAULT 0 COMMENT '是否特殊等级 默认否',
  `point_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '成长值范围类型 默认0 0介于 1大于',
  `min_points` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '成长值下限',
  `max_points` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '成长值上限',
  `type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '等级类型',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`rank_id`) USING BTREE
...
CREATE TABLE `user_rank_log` (
  ...
  `target_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '类型 1-订单 2-退单',
  `target_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '订单id或退款id',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户成长值记录表';
...
CREATE TABLE `user_real` (
  `real_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int UNSIGNED NOT NULL COMMENT '会员id',
  `real_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '真实姓名',
  ...
  `reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '审核原因',
  `status` tinyint NOT NULL DEFAULT 0 COMMENT '是否通过实名认证 0未认证 1已认证',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `user_shop_rank` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`rank_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户店铺等级表';
...
CREATE TABLE `video_dir` (
  ...
  `dir_desc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '描述',
  `dir_sort` smallint UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  `is_default` tinyint NOT NULL DEFAULT 0 COMMENT '是否默认视频文件夹',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`dir_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='视频目录表';
...
CREATE TABLE `weixin_keyword` (
  ...
  `key_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '关键词类型 0-自定义文字 1-自定义图文',
...
CREATE TABLE `weixin_material_group` (
  ...
  `type` tinyint NOT NULL DEFAULT 0 COMMENT '图文类型 0-单图文 1-多图文',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='微信素材分组表';
...
CREATE TABLE `weixin_menu` (
  ...
  `menu_type` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '菜单类型 0-命令 1-链接 2-自定义图文 3-关联小程序',
  ...
  `is_auto_login` tinyint NOT NULL DEFAULT 0 COMMENT '是否自动登录',
  ...
  `menu_level` tinyint UNSIGNED NOT NULL DEFAULT 1 COMMENT '菜单级别 默认1',
  `shop_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺id',
  `menu_sort` int UNSIGNED NOT NULL DEFAULT 255 COMMENT '排序',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='微信自定义菜单表';
...
CREATE TABLE `weixin_user` (
  ...
  `is_black` tinyint NOT NULL DEFAULT 0 COMMENT '是否为黑名单状态',
  `subscribe` tinyint NOT NULL DEFAULT 0 COMMENT '关注状态(0未关注,1已关注)',
  `nickname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '用户昵称',
  `sex` tinyint NOT NULL DEFAULT 0 COMMENT '用户性别(1男性,2女性,0未知)',
  ...
  `subscribe_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '关注时间',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '备注',
...
CREATE TABLE `yly_printer` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='易联云打印机表';
...
CREATE TABLE `yun_collect_stage` (
  `ycs_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `site_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '站点ID',
  `shop_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺ID',
  `third_goods_id` int UNSIGNED NOT NULL COMMENT '第三方商品ID编号',
  ...
  `collect_status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '采集状态 默认0 0-待采集 1-待导入 2-已导入',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`ycs_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='云采集商品暂存表';
