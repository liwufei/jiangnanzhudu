...
DialogManager = {
    ...
    'close'         :function(id){
		if(__DIALOG_WRAPPER__[id] != undefined && __DIALOG_WRAPPER__[id] != null) 
		{
    ...
    'createContents'  : function(type, options){
        ...
        switch(type){
            ...
            case 'message':
                ...
                _message_contents = $('<div class="dialog_message_contents dialog_message_' + type + ' center">' + options.text + '</div>');
