(function ($) {
	$.fn.compressUpload = function (options) {
		var defaults = { auto: true, swf: 'Uploader.swf', server: '', fileVal: 'file', pick: '#picker', runtimeOrder: 'html5,flash', multiple: false, compress: true, compressWidth: 400, compressHeight: 400, crop: true, compressSize: 0, formData: { fileval: options.fileval, ajax: 1 }, callback: function () { } };
		...
		// 初始化Web Uploader
		var uploader = WebUploader.create($.extend(opts, {
