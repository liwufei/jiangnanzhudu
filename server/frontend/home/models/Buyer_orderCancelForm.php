...
/**
 * @Id Buyer_orderCancelForm.php 2018.9.19 $
 * @author mosir
 */
		...
		foreach ($orders as $order_id => $orderInfo)
 		{
			...
			// 记录订单操作日志
			OrderLogModel::create($order_id, Def::ORDER_FINISHED, $post->remark ? $post->remark : $post->cancel_reason, addslashes($orderInfo['buyer_name']));
