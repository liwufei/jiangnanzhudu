...
//        }
        ...
        // 执行安装shell脚本
        $script_path = dirname(dirname(dirname(dirname(dirname(dirname(__DIR__)))))) . '/scripts/install_panel.sh';
        shell_exec("dos2unix {$script_path} 2>&1");
        $output = shell_exec("sh {$script_path} 2>&1");
