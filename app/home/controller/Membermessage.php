...
class Membermessage extends BaseMember
{
    ...
    protected function getMemberItemList()
    {
        $menu_array = array(
            1 => array(
                'name' => 'message',
                'text' => lang('home_message_received_message'),
                'url' => (string)url('Membermessage/message')
            ),
            2 => array(
                'name' => 'private',
                'text' => lang('home_message_private_message'),
                'url' => (string)url('Membermessage/privatemsg')
            ),
            3 => array(
                'name' => 'system',
                'text' => lang('home_message_system_message'),
                'url' => (string)url('Membermessage/systemmsg')
            ),
            4 => array(
                'name' => 'close',
                'text' => lang('home_message_close'),
                'url' => (string)url('Membermessage/personalmsg')
            ),
            5 => array(
                'name' => 'setting',
                'text' => lang('receiving_set'),
                'url' => (string)url('Membermessage/setting')
            )
        );
        if (request()->action() == 'sendmsg') {
            $menu_array[] = array(
                'name' => 'sendmsg',
                'text' => lang('home_message_send_message'),
                'url' => (string)url('Membermessage/sendmsg')
            );
        } elseif (request()->action() == 'showmsg') {
            $menu_array[] = array(
                'name' => 'showmsg',
                'text' => lang('home_message_view_message'),
                'url' => '#'
            );
        }
        return $menu_array;
