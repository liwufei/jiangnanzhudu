...
class Sellerpromotionwholesale extends BaseSeller
{
    ...
    protected function getSellerItemList()
    {
        $menu_array = array(
            array(
                'name' => 'wholesale_list',
                'text' => lang('promotion_active_list'),
        ...
        switch (request()->action()) {
            case 'wholesale_add':
                $menu_array[] = array(
                    'name' => 'wholesale_add',
                    'text' => lang('promotion_join_active'),
            ...
            case 'wholesale_edit':
                $menu_array[] = array(
                    'name' => 'wholesale_edit',
                    'text' => lang('editing_activity'),
                    'url' => 'javascript:;'
                );
                break;
            case 'wholesale_quota_add':
                $menu_array[] = array(
                    'name' => 'wholesale_quota_add',
                    'text' => lang('promotion_buy_product'),
                    'url' => (string) url('Sellerpromotionwholesale/wholesale_quota_add')
                );
                break;
            case 'wholesale_manage':
                $menu_array[] = array(
                    'name' => 'wholesale_manage',
                    'text' => lang('promotion_goods_manage'),
