...
class Statisticsflow extends BaseSeller
{
    ...
    public function initialize()
    {
        ...
        Lang::load(base_path() . 'home/lang/' . config('lang.default_lang') . '/statisticsflow.lang.php');
    ...
    public function index()
    {
        ...
        $where[] = array('flowstat_stattime', 'between', $searchtime_arr);
        $where[] = array('flowstat_type', '=', 'sum');
    ...
    public function goodsflow()
    {
        ...
        $where[] = array('store_id', '=', $store_id);
        $where[] = array('flowstat_stattime', 'between', $searchtime_arr);
        $where[] = array('flowstat_type', '=', 'goods');
        ...
        if ($statlist_tmp) {
            ...
            //查询相应商品
            $goods_list_tmp = $stat_model->statByGoods(array(array('goods_id', 'in', $goodsid_arr)), $field = 'goods_name,goods_id');
        ...
        return View::fetch($this->template_dir . 'flowgoods');
    }
    ...
    {
        $menu_array = array(
            array('name' => 'index', 'text' => lang('total_store_flow'), 'url' => (string) url('Statisticsflow/index')),
            array('name' => 'goodsflow', 'text' => lang('commodity_flow_ranking'), 'url' => (string) url('Statisticsflow/goodsflow'))
        );
        return $menu_array;
    }
}
