...
class Membervoucher extends BaseMember
{
    ...
    protected function getMemberItemList()
    {
        $menu_array = array(
            array(
                'name' => 'voucher_list',
                'text' => lang('ds_storevoucher'),
                'url' => (string)url('Membervoucher/storevoucher')
            ),
            array(
                'name' => 'mallvoucher_list',
                'text' => lang('ds_mallvoucher'),
                'url' => (string)url('Membervoucher/mallvoucher')
            )
        );
        return $menu_array;
    }
