...
class Statisticssale extends BaseSeller
{
            ...
            foreach ((array)$t_v as $k => $v) {
                ...
                if ($province_id) {
                    ...
                    $stat_arr_bar[$t_k]['series'][0]['data'][] = array(
                        'name' => strval($province_array[$province_id]),
                        'y' => $v[$t_k]
                    );
                    //横轴
    ...
    protected function getSellerItemList()
    {
        $menu_array = array(
            array(
                'name' => 'sale',
                'text' => lang('sales_statistics'),
                'url' => (string)url('Statisticssale/index')
            ),
            array(
                'name' => 'area',
                'text' => lang('regional_distribution'),
                'url' => (string)url('Statisticssale/area')
            ),
            array(
                'name' => 'buying',
                'text' => lang('buy_analysis'),
                'url' => (string)url('Statisticssale/buying')
            ),
        );
        return $menu_array;
    }
