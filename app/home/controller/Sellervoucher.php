        ...
        switch (request()->action()) {
            case 'templatelist':
                $menu_array = array(
                    1 => array(
                        'name' => 'templatelist',
                        'text' => lang('ds_member_path_store_voucher'),
            ...
            case 'quotaadd':
                $menu_array = array(
                    ...
                    array(
                        'name' => 'quotaadd',
                        'text' => lang('voucher_applyadd'),
                        'url' => (string) url('Sellervoucher/quotaadd')
                    )
                );
                break;
            case 'templateadd':
            ...
            case 'templateedit':
                $menu_array = array(
                    ...
                    2 => array(
                        'name' => 'templateedit',
                        'text' => lang('voucher_templateedit'),
                        'url' => ''
                    ),
                );
                break;
            case 'templateinfo':
                $menu_array = array(
                    ...
                    2 => array(
                        'name' => 'templateinfo',
                        'text' => lang('voucher_templateinfo'),
                        'url' => ''
                    ),
                );
                break;
