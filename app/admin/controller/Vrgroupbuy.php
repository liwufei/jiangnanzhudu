...
class Vrgroupbuy extends AdminControl
{
    ...
    protected function getAdminItemList()
    {
        $menu_array = array(
            array(
                'name' => 'index',
                'text' => lang('vrgroupbuy_cate_manage'),
                'url' => (string)url('Vrgroupbuy/index')
            ),
            array(
                'name' => 'class_add',
                'text' => lang('vrgclass_add'),
                'url' => "javascript:dsLayerOpen('" . (string)url('Vrgroupbuy/class_add') . "','" . lang('vrgclass_add') . "')"
            )
        );
        return $menu_array;
    }
