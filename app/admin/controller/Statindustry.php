...
class Statindustry extends AdminControl
{
    ...
    protected function getAdminItemList()
    {
        $menu_array = array(
            array(
                'name' => 'scale',
                'text' => lang('stat_industryscale'),
                'url' => (string)url('Statindustry/scale')
            ),
            array(
                'name' => 'rank',
                'text' => lang('stat_industryrank'),
                'url' => (string)url('Statindustry/rank')
            ),
            array(
                'name' => 'price',
                'text' => lang('stat_industryprice'),
                'url' => (string)url('Statindustry/price')
            ),
            array(
                'name' => 'general',
                'text' => lang('stat_industrygeneral'),
                'url' => (string)url('Statindustry/general')
            )
        );
        return $menu_array;
    }
