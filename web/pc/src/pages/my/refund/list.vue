			...
			<el-col :span="20">
				...
				<div class="round-edge pl20 pr20 pt20 pb20 bgf mt20">
					...
					<el-table :data="gallery" v-loading="loading" size="large" :border="false" :stripe="false"
						...
						<el-table-column prop="store_name" label="卖家" width="150" sortable />
						...
						<el-table-column fixed="right" label="操作" width="100" align="center">
							<template #default="scope">
								<router-link class="rlink f-blue mb5" :to="'/my/refund/detail/' + scope.row.refund_id">
									退款详情</router-link>
...
import { myRefundList } from '@/api/refund.js'
...
function getList(params) {
	myRefundList(Object.assign(form, params), (data) => {
